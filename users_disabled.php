...
$res = mysqli_query($con_link, "SELECT * FROM users WHERE enabled='no'") or sqlerr(__FILE__, __LINE__);
...
while ($row = mysqli_fetch_assoc($res))
	...
	print "<input type=hidden name=returnto value='users_disabled.php'>";
	print "<input type=submit style='height: 22px;width: 150px;color:red;font-weight:bold' value='VERWIJDER'>";
	print "</form>";
	print "</td>";
	print "</tr>";
