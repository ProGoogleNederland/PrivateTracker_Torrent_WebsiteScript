...
/* $Id: mysqli_stats.php,v 1.0 2005/06/20 22:52:24 CoLdFuSiOn Exp $ */
...
if (get_user_class() < UC_OWNER)
	site_error_message("Error", "NIET TOEGESTAAN VOOR JOU.");
 ...
 */
echo '<h2>' . "\n"
   . '    <font color=yellow>Mysql Server Status</font>'  . "\n"
   . '</h2>' . "\n";
 ...
 */
$res = @mysqli_query($con_link, 'SHOW STATUS') or Die(mysqli_error($con_link));
...
<ul>
    <li>
        <!-- Server Traffic -->
        <b><font color=yellow>Server traffic:</b> These tables show the network traffic statistics of this MySQL server since its startup</font>
        <br />
        <table border="0">
            <tr>
                <td valign="top">
    ...
    <li>
        <!-- Queries -->
        <?php print("<b><font color=yellow>Query Statistics:</b> Since it's start up, ". number_format($serverStatus['Questions'], 0, '.', ',')." queries have been sent to the server.\n</font>"); ?>
        <table border="0">
            <tr>
                <td colspan="2">
                    <br />
...
?>
    ...
    <li>
        ...
        <b><font color=yellow>More status variables</font></b><br />
        <table border="0">
            <tr>
                <td valign="top">
                    <table id="torrenttable" border="0">
